...
def page_3():
    ...
    if survey_type == "1 жил хүртэл":
        ...
        q1 = st.radio(
            label="Доорх үнэлгээнээс сонгоно уу. **5 од нь хамгийн өндөр, 1 од нь хамгийн бага үнэлгээ** болно.",  # remove "Таны үнэлгээ (1–5 од):"
            options=["⭐", "⭐⭐", "⭐⭐⭐", "⭐⭐⭐⭐", "⭐⭐⭐⭐⭐"],
            key="q1_1jil",
            index=None
        )
        ...
        st.markdown("Доорх үнэлгээнээс сонгоно уу. **5 од нь хамгийн өндөр, 1 од нь хамгийн бага үнэлгээ** болно.")
        q1 = st.radio(
            label="",  # remove "Таны үнэлгээ (1–5 од):"
            options=["⭐", "⭐⭐", "⭐⭐⭐", "⭐⭐⭐⭐", "⭐⭐⭐⭐⭐"],
            key="q1_1deesh",
            index=None
        )
        ...
        q1 = st.multiselect("Үндсэн шалтгаануудыг сонгоно уу:", q1_choices, key="q1_6sar")
        ...
        q1 = st.multiselect("Үндсэн шалтгаануудыг сонгоно уу:", q1_choices, key="q1_busad")
        answer_key = "Reason_for_Leaving"
        if q1:
            st.session_state.answers[answer_key] = ", ".join(q1)
