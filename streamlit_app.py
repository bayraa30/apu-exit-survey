...
def page_4():
    ...
    q2 = st.radio(
        label="**5 нь хамгийн сайн, 1 нь хангалтгүй** үнэлгээ гэж үзнэ.",
        options=[
            "5 - Маш сайн мэдээлэл, заавар өгсөн",
            "4 - Сайн мэдээлэл, заавар өгсөн",
            "3 - Дунд зэрэг мэдээлэл, заавар өгсөн",
            "2 - Муу мэдээлэл, заавар өгсөн",
            "1 - Хангалтгүй"
        ],
...
def page_5():
    ...
    if survey_type == "1 жил хүртэл":
        ...
        q3 = st.radio(
            label="Доорх үнэлгээнээс сонгоно уу. **5 нь хамгийн өндөр, 1 нь хамгийн бага үнэлгээ** болно.",
            options=q3_choices,
            key="q3_1deesh",
            index=None
        )
        ...
        q3_choices = [
            "Маш сайн мэдээлэл, заавар өгсөн /5/",
            "Сайн мэдээлэл, заавар өгсөн /4/",
